...
public class DataManager : MonoBehaviour, IGameManager {
	...
	public void SaveGameState() {
		...
		gamestate.Add("gold", Managers.Player.gold);
		gamestate.Add("score", Managers.Player.score);
	...
	public void LoadGameState() {
		...
		Managers.Player.UpdateData((int)gamestate["health"], (int)gamestate["maxHealth"], (int)gamestate["gold"], (int)gamestate["score"]);
		Managers.Mission.UpdateData((int)gamestate["curLevel"] == 0 ? 1 : (int)gamestate["curLevel"], (int)gamestate["maxLevel"]);
